...
Use as fundamentals support, not the June 7-16 blocker unless needed.
...
- The new paper must be complete before 2026-06-26.
...
- Therefore the paper target is 2026-06-25, with topic selection and research overlapping the final light STAT31450 support lane.

Earliest solid paper target:

- Target complete draft: 2026-06-25.
- Stretch target if research and drafting overlap unusually well: 2026-06-24.
...
| --- | --- | --- | --- |
| 2026-06-07 | L2 + HW2; HW2 notebook runs; variance/numerical method notes | Chapter 6 + HW5; finish chapter 6 gap; repair final weak question | Laplace's Equation; Rectangle Problems for Laplace's Equation; Laplace's Equation Inside a Circular Disk |
| 2026-06-08 | L3 + HW3; HW3 notebook runs; changed-input variant | Chapter 7 + HW6; annealing/tempering implementation | Homework 4 Laplace practice; Solvability Condition; Neumann Solvability and Flux Balance |
| 2026-06-09 | L4 + HW4; HW4 notebook runs; convergence/diagnostic notes | Chapter 8 + HW7; HMC implementation and tuning log | Wave Equation; Wave Equation Derivation; Backward heat equation and ill-posedness |
| 2026-06-10 | L5 + HW5; notebook runs; coding-heavy pieces repaired | Chapter 9 + HW8; particle filter implementation and ESS/resampling diagnostics | Homework 4 wave/backward-heat practice; Sturm--Liouville Eigenvalue Problems; Sturm--Liouville Conversions |
| 2026-06-11 | L6 + HW6; both HW6 notebooks run end to end | Chapter 10 + HW9; EM or VI implementation and objective notes | Homework 5 Sturm--Liouville practice; Sturm--Liouville Proof Details; Self-Adjoint Operators & Sturm--Liouville Problems |
| 2026-06-12 | L7-L8 + HW7; both HW7 notebooks run; L8 reviewed | STAT31511 consolidation; chapters 6-10 method map; repair any failed node | Adjoints and the Fredholm alternative; Homework 5 adjoint/Fredholm practice; Green's Function; Green identities and symmetry |
| 2026-06-13 | FINM method map; pricing method, estimator, convergence claim | STAT method review; target, estimator, diagnostics, failure modes | Green's Function Boundary Reduction; Homework 6 Green-identity practice; Green's Functions and Source Terms; Nonhomogeneous Heat Equations and Duhamel's Principle |
| 2026-06-14 | FINM changed-input variants; repair failed notebooks | STAT coding repairs; rerun weakest implementation | Wave Green function by eigenfunction expansion; Direct construction and resonance; Homework 6 source/resonance practice; Fourier Transforms |
| 2026-06-15 | Cross-course option-pricing method synthesis | Monte Carlo evidence standards for paper experiments | Fourier Transform Applications; Heat equation on the real line; Fourier transform properties used in the examples |
| 2026-06-16 | Final FINM recall sheet and runnable proof points | Final STAT recall sheet and runnable proof points | Wave equation on the real line; Heat equation on a half-line; Homework 7 transform practice A |
| 2026-06-17 | FINM light recall maintenance | STAT light recall maintenance | Laplace's equation on a semi-infinite strip; Laplace's equation on an infinite strip; Homework 7 strip practice |
| 2026-06-18 | FINM/STAT paper-seed scan | STAT/FINM paper-seed scan | Laplace's equation on a half-plane; Convection--diffusion and bounded multidimensional domains; Homework 7 half-plane/convection practice |
| 2026-06-19 | Research day 1 support | Literature note cleanup support | Introduction & Review; Heat Equation |
| 2026-06-20 | Research day 2 support | FINM numerical-method recall support | Homework 1 heat-equation practice; Separation of Variables |
| 2026-06-21 | Research day 3 support | STAT Monte Carlo diagnostic recall support | Fourier Series |
| 2026-06-22 | Research day 4 support | PDE method recall support | Homework 2 Fourier-series practice; Term-by-Term Differentiation |
| 2026-06-23 | Research day 5 support | Claims/limitations notes support | Back to Solving PDEs Using Separation of Variables; Homework 3 eigenfunction-expansion practice; final PDE recall sheet |
...
Parallel relearn checkpoint on 2026-06-23:
...
Paper is the heavy lane from 2026-06-18 through 2026-06-25. Each day keeps one light lane for maintenance or support, not a third major task.

| Date | Heavy Lane | Light Lane | Required Output |
| --- | --- | --- | --- |
| 2026-06-18 | Research problem search | Three-course method-map cleanup | Pick one interesting Options + Monte Carlo + PDE-adjacent problem; write research question, novelty angle, minimal experiment, and kill criteria |
| 2026-06-19 | Research day 1 | Literature note cleanup | Literature skim and baseline method; decide exact model/data/simulation setup |
| 2026-06-20 | Research day 2 | FINM numerical-method recall | Build minimal experiment or replication scaffold |
| 2026-06-21 | Research day 3 | STAT Monte Carlo diagnostic recall | Run first meaningful experiment; log failures |
| 2026-06-22 | Research day 4 | PDE method recall | Improve experiment; generate first usable table/figure |
| 2026-06-23 | Research day 5 | Claims/limitations notes | Finish evidence package; freeze scope |
| 2026-06-24 | Draft paper | Reference and format pass | Full 8-page-or-less ACM-style draft with placeholders resolved |
| 2026-06-25 | Finalize paper | Submission-readiness checklist | Tighten claims, references, formatting, figures, and self-contained story |

Daily maintenance during paper period:

- LeetCode short daily practice.

Paper checkpoint on 2026-06-25:
...
| --- | --- | --- | --- |
| LeetCode | 2026-06-07 onward | Short daily practice, no long-hour requirement | Daily continuity for coding interviews |
| Probability + Stochastic Calculus + FINM33000 | 2026-06-26 to 2026-08-29 | Daily low-dose probability/stochastic/options work | Quant probability map, `finbook` chapters 2-6 cards, FINM33000 fundamentals repair |
| Linear Algebra + Matrix Computation | 2026-06-26 to 2026-08-29 | Small daily topic card + exercises | 100 selected exercises, OLS projection derivation, SVD/PCA/conditioning cards |
| Econometrics + Time Series | 2026-06-26 to 2026-08-29 | BUSN41902 plus undergrad time-series notes, one concept/model per day | OLS/econometrics concept map; stationarity/ACF/ARMA/ARIMA/forecast diagnostics |
...
| Interview Synthesis | 2026-08-30 onward | Three balanced maintenance lanes plus daily LeetCode | Mixed probability/options/MC/PDE practice, project polish, maintenance review |

### Phase 1B Daily Lane Groups

| Dates | Lane Count | Daily Lanes |
| --- | ---: | --- |
| 2026-06-07 to 2026-06-17 | 3 plus LeetCode | FINM32000; STAT31511; STAT31450 PDE; daily LeetCode |
| 2026-06-18 to 2026-06-25 | 2 plus LeetCode | Paper-heavy lane plus one light STAT31450 support lane through 2026-06-23; daily LeetCode |
| 2026-06-26 to 2026-07-28 | 3 plus LeetCode | Linear Algebra + Matrix Computation; Probability + Stochastic Calculus + FINM33000; Econometrics + Time Series; daily LeetCode |
...
| 2026-08-03 to 2026-08-29 | 3 plus LeetCode | Linear Algebra + Matrix Computation; Probability + Stochastic Calculus + FINM33000; Econometrics + Time Series; daily LeetCode |
| 2026-08-30 onward | 3 plus LeetCode | Interview problem practice; project/paper polish; weak-area maintenance; daily LeetCode |
...
- LeetCode as a must-do daily maintenance thread from 2026-06-07 onward.
...
- Postponed probability track after 2026-06-25.
- Probability + stochastic calculus + FINM33000 lane starts after the paper on 2026-06-26 and continues long.
...
- June 14 target revised to current paper target of 2026-06-25.
...
- Probability + stochastic calculus + FINM33000 starts after the paper on 2026-06-26.
